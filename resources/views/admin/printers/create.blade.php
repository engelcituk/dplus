                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <select class="form-control" name="use_mode" required>
                                        <option value="compartido" {{old('use_mode') == 'usb/compartido' ? 'selected': '' }}>Impresora usb/compartida</option>
                                        <option value="ip" {{old('use_mode') == 'red/ip' ? 'selected': '' }}>Por red/ip</option>
